...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <form class="form-horizontal" name="form1" method="post" action="<?php echo base_url('admin/laporan/tampil_pustu/'.$tmt.'/'.$tmtdua.'/'.$id_satker) ?>" enctype="multipart/form-data">
   ...
   <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Pustu</label>
    <div class="col-sm-4">
...
<div class="form-group">
  <div class="col-sm-offset-2 col-sm-10">
    ...
    <a href="<?php echo base_url('admin/laporan/cetak_pustu/'.$tmt.'/'.$tmtdua.'/'.$id_satker) ?>" class="btn btn-danger btn-md" target="_blank"><i class="fa fa-file-excel-o"></i> Export Excel</a>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <h2 class="page-header">Laporan Barang Masuk <?php echo date('d-m-Y',strtotime($tmt)) ?> s/d <?php echo date('d-m-Y',strtotime($tmtdua)) ?>  </h2>
    <!-- Custom Tabs -->
          ...
          <table id="example1" class="table table-bordered table-striped">
            <thead>
             ...
             <tr class="bg-primary">
               ...
               <th width="138">Tanggal Datang</th>
           ...
           <tbody>
            ...
            $i=1; foreach ($brg as $brg) {
              ...
              $id_barang  = $brg['id_msk_kel'];
              $jml_masuk   = $this->Brg_masukkel_model->get_jumlah_stok($id_satker,$id_barang,$tmt,$tmtdua);
              $jml_keluar  = $this->Brg_keluarkel_model->get_jumlah_stok($id_satker,$id_barang,$tmt,$tmtdua);
