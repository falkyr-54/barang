...
class Dasbor extends CI_Controller
{
	...
	public function index()
	{
		...
		// $expired6bln = $this->Brg_keluar_model->list_expired6bulan($id_barang);
		// $atk	= $this->dasbor_model->atk($tahun);
		// $cu		= $this->dasbor_model->cu($tahun);
		// $it		= $this->dasbor_model->it($tahun);
		// $art	= $this->dasbor_model->art($tahun);
		// $ctk	= $this->dasbor_model->ctk($tahun);
		// $alk	= $this->dasbor_model->alk($tahun);
