...
class Permintaan_pengadaan_model extends CI_Model
{
	...
	public function get_permintaan_by_satker()
	{
		$this->db->select('permintaan_pengadaan.*, ms_barang.nama_barang, user.nama_user, satker.nama_satker');
		$this->db->from('permintaan_pengadaan');
		$this->db->join('ms_barang', 'ms_barang.id_barang = permintaan_pengadaan.id_barang', 'left');
		$this->db->join('user', 'user.username = permintaan_pengadaan.nama_request', 'left');
		$this->db->join('satker', 'satker.id_satker = permintaan_pengadaan.id_satker', 'left');
		// $this->db->where('permintaan_pengadaan.id_satker', $id_satker);
	...
	public function ajukanPengadaan($data)
	{
		$this->db->insert('permintaan_pengadaan', $data);
		return $this->db->insert_id();
	}
	public function cekSudahAjukan($id_barang, $username, $id_satker)
	{
		return $this->db->where('id_barang', $id_barang)
			->where('nama_request', $username)
			->where('id_satker', $id_satker) // tambahan filter satker
			->get('permintaan_pengadaan')
			->row_array();
	}
