                ...
                <div class="modal-body" style="padding: 20px;overflow-y:auto;">
                    ...
                    <!-- Tombol Tolak: merah -->
                       ...
                       <!--  <button type="button" class="btn btn-default" data-dismiss="modal">
                        ...
                        <a href="<?php echo base_url('admin/pj_klaster') ?>" class="btn btn-success"><i class="fa fa-check"></i> Setujui</a>


                        <a href="<?php echo base_url('admin/pj_klaster/tolak/') ?>" class="btn btn-danger"><i class="fa fa-check"></i> Tolak</a>
                    </div>
                </div>
                <!-- </form> -->
                <!-- End of form -->
