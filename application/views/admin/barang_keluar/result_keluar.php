...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <form class="form-horizontal" name="form1" method="post" action="<?php echo base_url('admin/barang/pencarian_keluar/'.$tmt.'/'.$tmtdua) ?>" enctype="multipart/form-data">
...
<div class="row">
  <div class="col-md-12">
    <h2 class="page-header">Transaksi Barang Keluar <?php echo date('d-m-Y',strtotime($tmt)) ?> Sampai <?php echo date('d-m-Y',strtotime($tmtdua)) ?>  </h2>
    <!-- Custom Tabs -->
      ...
      <div class="box-body table-responsive no-padding">
        <div class="box" style="width:99%;">
          <a class="btn btn-block btn-social btn-flickr">
            <i class="fa fa-linkedin"></i> Transaksi Barang Keluar
          </a>
          <br>
