        ...
        <div class="col-md-12">
          ...
          <!--  <div class="form-group has-warning">
            ...
            <div class="form-group" hidden="">
              ...
              <input type="hidden" name="id_satker" class="form-control" value="<?php echo set_value('id_satker') ?>" placeholder="NIP pegawai Pengganti" required id="id_satker" readonly>
            </div>
            ...
            <div class="form-group has-warning">
              ...
              <select class="form-control" name="akses_level">
                ...
                <option value="admin_poli">admin poli/unit</option>
