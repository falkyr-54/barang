  ...
  <div class="box" style="width:99%;">
    ...
    <table id="example1" class="table table-bordered table-striped">
      <thead>
        ...
        <tr class="bg-primary">
          <th width="17">No</th>
          <th width="17">Penyedia</th>
          <th width="17">Nama Barang</th>
          <th width="27">Spesifikasi</th>
          <th width="27">Jenis Pemesanan</th>
          <th width="27">Metode Pengadaan</th>
      ...
      <tbody>
        ...
        foreach ($masuk as $masuk) { ?>
          <tr>
            ...
            <td><?php echo $masuk['jenis_pemesanan'] ?></td>
            <td><?php echo $masuk['metode_pengadaan'] ?></td>
