...
<div class="col-md-6">
	<div class="form-group">
    	<label>Icon Quote 1 (Current icon: <i class="fa <?php echo $site['pesan_1'] ?>"></i> <?php echo $site['pesan_1'] ?>)</label>
       <select name="pesan_1" class="form-control">
       		<?php echo $icon ?>
       </select>
    </div>
    
    <div class="form-group">
    	<label>Icon Quote 2 (Current icon: <i class="fa <?php echo $site['pesan_2'] ?>"></i> <?php echo $site['pesan_2'] ?>)</label>
       <select name="pesan_2" class="form-control">
       		<?php echo $icon ?>
       </select>
    </div>
    
    <div class="form-group">
    	<label>Icon Quote 3 (Current icon: <i class="fa <?php echo $site['pesan_3'] ?>"></i> <?php echo $site['pesan_3'] ?>)</label>
       <select name="pesan_3" class="form-control">
       		<?php echo $icon ?>
       </select>
    </div>
    
    <div class="form-group">
    	<label>Icon Quote 4 (Current icon: <i class="fa <?php echo $site['pesan_4'] ?>"></i> <?php echo $site['pesan_4'] ?>)</label>
       <select name="pesan_4" class="form-control">
       		<?php echo $icon ?>
       </select>
    </div>
    
    <div class="form-group">
    	<label>Icon Quote 5 (Current icon: <i class="fa <?php echo $site['pesan_5'] ?>"></i> <?php echo $site['pesan_5'] ?>)</label>
       <select name="pesan_5" class="form-control">
       		<?php echo $icon ?>
       </select>
    </div>
    
    <div class="form-group">
    	<label>Icon Quote 6 (Current icon: <i class="fa <?php echo $site['pesan_6'] ?>"></i> <?php echo $site['pesan_6'] ?>)</label>
       <select name="pesan_6" class="form-control">
       		<?php echo $icon ?>
       </select>
    </div>
