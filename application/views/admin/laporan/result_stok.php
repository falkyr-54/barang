      ...
      <?php foreach ($jenis as $jenis) { ?>
        <option value="<?php echo $jenis['id_jenis'] ?>"
          <?php if(isset($_POST['id_jenis']) && $_POST['id_jenis']==$jenis['id_jenis']) { 
            echo "selected"; } ?>><?php echo $jenis['nama_jenis'] ?>
          </option>
        <?php } ?>
      </select>
    </div>
...
<div class="form-group">
  <div class="col-sm-offset-2 col-sm-10">
    ...
    <a href="<?php echo base_url('admin/laporan/cetak_excel/'.$tmt.'/'.$tmtdua.'/'.$id_jenis) ?>" class="btn btn-danger btn-md" target="_blank"><i class="fa fa-file-excel-o"></i> Export Excel</a>
  </div>
</div>
