  ...
  <div class="box box-warning">
   ...
   <!--    <div class="form-group">
      ...
      <div class="form-group" hidden="">
        <label>Id unit</label>
        <input type="hidden" name="id_unit" class="form-control" value="<?php echo $pegawai['id_unit'] ?>" placeholder="" required id="id_unit" readonly>
      </div>

      <div class="form-group" hidden="">
        <label>id pegawai</label>
        <input type="hidden" name="id_pegawai" class="form-control" value="<?php echo $pegawai['id_pegawai'] ?>" placeholder="" required id="id_pegawai" readonly>
      </div>

       <div class="form-group" hidden="">
        <label>id satker</label>
        <input type="hidden" name="id_satker" class="form-control" value="<?php echo $pegawai['id_satker'] ?>" placeholder="" required id="id_pegawai" readonly>
      </div>
      ...
      <div class="form-group" hidden="">
        ...
        <input type="hidden" class="form-control" name="id_jenis" value="<?php echo $barang['id_jenis'] ?>" id="id_jenis" readonly>
      </div>
