        ...
        <?php } elseif ($klast['status_validasi'] == "acc_p") { ?>
            <div class="modal fade" id="Approve<?php echo $klast['id_barang_keluar'] ?>" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-md">
                    ...
                    <form action="<?php echo base_url('admin/admin_barang/approve_kasih/' . $klast['id_barang_keluar']) ?>" method="post">

                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span>
                                    <span class="sr-only">Close</span></button>
                                    <h4 class="modal-title" id="myModalLabel">Setujui barang ini untuk diberikan ??</h4>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group mb-3">
                                        ...
                                        class="form-control"
                                        value="<?php echo $klast['nama_barang'] ?>"
                                        disabled>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        class="form-control"
                                        value="<?php echo $klast['jumlah_keluar'] ?>"
                                        disabled style="max-width:120px;">
                                        <small><?php echo $klast['satuan'] ?></small>
                                    </div>
