...
<div class="modal fade" id="Approve<?php echo $klast['id_barang_keluar'] ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-md">
        <form action="<?php echo base_url('admin/pj_klaster/approve/' . $klast['id_barang_keluar']) ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        value="<?php echo $klast['jumlah_keluar'] ?>" readonly>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?php echo base_url('admin/pj_klaster/tolak/' . $klast['id_barang_keluar'] . '/' . $tmt . '/' . $sampai) ?>"
